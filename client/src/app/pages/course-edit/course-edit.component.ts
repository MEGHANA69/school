    ...
    ngOnInit() {
        this.route.params.subscribe(param => {
            ...
            if (id !== 'new') {
                ...
                this.examService.findBy_courses(id).subscribe(list => this.externalExam__courses = list);
            }
            // Get relations
        });
    }
